...
struct OnTheFlyRichPid {
  ...
  Configurable<float> multiplicityEtaRange{"multiplicityEtaRange", 20, "eta range to compute the multiplicity"};
  ...
  // Up to 23 sectors
  // float eta_sampling[25] = {-2.000000, -1.909740, -1.731184, -1.552999, -1.375325, -1.198342, -1.022276, -0.847390, -0.673976, -0.502324, -0.332683, -0.165221, 0.000000, 0.165221, 0.332683, 0.502324, 0.673976, 0.847390, 1.022276, 1.198342, 1.375325, 1.552999, 1.731184, 1.909740, 2.000000};
  // float res_ring_sampling_with_abs_walls[25] = {0.0009165, 0.000977, 0.001098, 0.001198, 0.001301, 0.001370, 0.001465, 0.001492, 0.001498, 0.001480, 0.001406, 0.001315, 0.001241, 0.001325, 0.001424, 0.001474, 0.001480, 0.001487, 0.001484, 0.001404, 0.001273, 0.001197, 0.001062, 0.000965, 0.0009165};
  // float res_ring_sampling_without_abs_walls[25] = {0.0009165, 0.000977, 0.001095, 0.001198, 0.001300, 0.001369, 0.001468, 0.001523, 0.001501, 0.001426, 0.001299, 0.001167, 0.001092, 0.001179, 0.001308, 0.001407, 0.001491, 0.001508, 0.001488, 0.001404, 0.001273, 0.001196, 0.001061, 0.000965, 0.0009165};
  // int size_res_vector = 0; ///// sizeof(eta_sampling) / sizeof(eta_sampling[0]);
  ...
  /// \param track_relative_pt_resolution the relative resolution on pt
  /// \param track_relative_pt_resolution the relative resolution on eta
  /// \param mass the mass of the particle
